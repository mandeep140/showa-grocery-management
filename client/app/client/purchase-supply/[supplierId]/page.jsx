      ...
      <div className='mx-auto w-full max-w-[980px]'>
        <div className='mb-7 flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center'>
          <div>
            ...
            <h1 className='mt-4 text-3xl font-semibold text-[#2F2F2F] sm:text-4xl'>Supplier Details</h1>
          </div>
          <button className='inline-flex h-10 items-center justify-center gap-1.5 rounded-lg bg-[#008C83] px-4 text-sm font-semibold text-white transition-colors hover:bg-[#007A72] max-sm:w-full'>
        ...
        <div className='space-y-5'>
          ...
          <section className={`${cardClass} overflow-hidden`}>
            ...
            <footer className='flex flex-col items-start justify-between gap-3 border-t border-[#ECECEC] px-4 py-3 text-xs text-[#8b8f92] sm:flex-row sm:items-center'>
