      ...
      <div className='mx-auto w-full max-w-[980px]'>
        ...
        <div className='space-y-5'>
          <div className='grid gap-3 sm:grid-cols-3'>
            <div className={`${statCardClass} flex flex-col gap-2`}>
          ...
          <div className={`${cardClass} flex flex-col gap-2 p-3 sm:flex-row`}>
                  ...
                  <tbody>
                    {suppliers.map((supplier) => (
                      <tr key={supplier.id} className='border-t border-[#ECECEC] text-sm text-[#2f3b43]'>
                        ...
                        <td
                          className={`px-4 py-3.5 text-right font-semibold ${supplier.outstanding > 0 ? 'text-[#ef5c55]' : 'text-[#22a061]'
                            }`}
                        >
                        ...
                        <td className='px-4 py-3.5'>
                          <span
                            className={`inline-flex items-center gap-1.5 rounded-full px-2 py-0.5 text-xs font-semibold ${supplier.status === 'Active' ? 'bg-[#EAF8EF] text-[#29985a]' : 'bg-[#f3f4f6] text-[#7d868d]'
                              }`}
                          >
                            {supplier.status === 'Active' && <span className='h-2 w-2 rounded-full bg-[#4CAF50]' />}
                            {supplier.status}
                          </span>
                        </td>
                        <td className='px-4 py-3.5'>
