...
const Edit = () => {
  return (
    <div className='w-full min-h-screen px-15 py-20 bg-[#E6FFFD]'>
            ...
            <p className='text-sm text-gray-400 mb-10'>Edit a supplier record.</p>
            <div className='w-[80%] mx-auto bg-white p-6 rounded-lg'>
                ...
                <form className='flex flex-col gap-6'>
                    ...
                    <div className='w-full flex items-center justify-between gap-4 mt-4'>
                        ...
                        <button type='submit' className='px-6 py-2 bg-[#008C83] text-white rounded-lg hover:bg-[#007571] duration-200'>Save changes</button>
                    </div>
                </form>
            </div>
    </div>
